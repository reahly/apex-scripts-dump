"resource/ui/menus/panels/store_collection_event.res"
{
	...
	AboutButton
	{
	    ...
	    pin_to_sibling_corner	TOP_LEFT
	    xpos				    -50
	    xpos_nx_handheld	    -15		[$NX]
	    ypos				    -360
	    wide				    530
	    wide_nx_handheld	    670		[$NX]
	    tall				    50
	...
	OpenPackButton
	{
	    ...
	    xpos_nx_handheld         -15	[$NX]
	    ypos                    33
	    ypos_nx_handheld        280		[$NX]
	    wide                    308
	    wide_nx_handheld        500		[$NX]
	    tall                    88
	    tall_nx_handheld        143		[$NX]
	    proportionalToParent    1
