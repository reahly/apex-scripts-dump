...
#if(CLIENT)
bool function CanUseBlackMarket( entity player, entity ent )
{
...
void function SetupMapRui( entity ent, var rui, bool isFullMap )
{
	...
	RuiSetFloat( rui, "areaImageAlpha", 1.0 )
	RuiSetImage( rui, "clampedImage", $"" )

	string areaColorArgName = "objColor"
	if ( isFullMap )
	{
		RuiSetColorAlpha( rui, "objColor", <1, 1, 1>, 1 )
	}
	else
	{
	...
	RuiSetColorAlpha( rui, areaColorArgName, <1, 1, 1>, 1 )
