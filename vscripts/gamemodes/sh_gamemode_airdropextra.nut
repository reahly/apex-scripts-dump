...
void function OnServerVarChanged_AirdropExtra_AirdropTier( entity player, int old, int new, bool actuallyChanged )
{
	if ( GetGameState() != eGameState.Playing )
		return

	printf( "AIRDROP EXTRAVAGANZA: server var changed: " + old + " " + new + " " + actuallyChanged )
...
void function OnServerVarChanged_AirdropExtra_AirdropProgress( entity player, int old, int new, bool actuallyChanged )
{
	if ( GetGameState() != eGameState.Playing )
		return
