...
struct {
	...
	table<var, EadpInviteToPlayData> buttonToResultMap
...
void function FindClubMemberDialog_OnSearchResult( int error, string errorReason, array<EadpInviteToPlayData> results )
{
	if ( file.searchState != eFindClubMemberState.SEARCHING )
		return
	...
	array<EadpInviteToPlayData> finalResults
