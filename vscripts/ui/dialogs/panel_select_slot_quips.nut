global function InitSelectSlotQuipsPanel
...
void function InitSelectSlotQuipsPanel( var panel )
{
	file.panel = panel
...
void function ApplyItemToButton( var button, ItemFlavor flavor )
{
	...
	if ( type == eItemType.gladiator_card_kill_quip || type == eItemType.gladiator_card_intro_quip )
		...
		CreateNestedRuiForQuip( Hud_GetRui( button ), "badgeUIHandle", LocalClientEHI(), flavor, character )
