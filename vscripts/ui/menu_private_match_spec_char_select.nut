...
void function InitPrivateMatchSpectCharSelectMenu( var newMenuArg )
{
	...
	file.whiteFlash = Hud_GetChild( newMenuArg, "WhiteFlash" )
		...
		if ( !file.isInitialized )
		{
			...
			AddCallback_GameStateEnter( eGameState.Prematch, OnGameStateEnter_Prematch )
			AddCallback_GameStateEnter( eGameState.WaitingForPlayers, OnGameStateEnter_WaitingForPlayers )
...
void function OnGameStateEnter_Prematch()
{
#if(DEV)
	//
#endif
...
void function OnGameStateEnter_WaitingForPlayers()
{
}
