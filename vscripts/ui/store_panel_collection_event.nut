...
void function CollectionEventPanel_UpdateGRXDependantElements()
{
	...
	if ( haveActiveCollectionEvent )
	{
		...
		HudElem_SetRuiArg( file.completionRewardBox, "bgPatternImage", CollectionEvent_GetBGPatternImage( activeCollectionEvent ) )
		HudElem_SetRuiArg( file.completionRewardBox, "itemImage", CollectionEvent_GetHeirloomButtonImage( activeCollectionEvent ) )
		HudElem_SetRuiArg( file.completionRewardBox, "itemsOwnedCount", CollectionEvent_GetItemCount( activeCollectionEvent, true, GetUIPlayer() ) )
		HudElem_SetRuiArg( file.completionRewardBox, "totalItemsCount", CollectionEvent_GetItemCount( activeCollectionEvent, false, GetUIPlayer() ) )
...
void function CompletionRewardBox_OnClick( var btn )
{
	...
	ItemFlavor item = CollectionEvent_GetPrimaryCompletionRewardItem( activeCollectionEvent )
	if ( !IsItemFlavorInspectable( item ) )
		return

	SetCollectionEventItemPresentationModeActive( item, null, null, null )
}
