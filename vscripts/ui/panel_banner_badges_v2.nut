...
ToolTipData function CreateBadgeToolTip( ItemFlavor badge, ItemFlavor ornull character )
{
	...
	string badgeHint                          = GladiatorCardBadge_IsCharacterBadge( badge ) ? Localize( "#CHARACTER_BADGE", Localize( ItemFlavor_GetLongName( expect ItemFlavor( character ) ) ) ) : "#ACCOUNT_BADGE"
