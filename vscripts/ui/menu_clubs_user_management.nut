...
void function UpdateMemberSettingsDisplay()
{
	...
	if ( IsDisplayingReports() )
		...
		thread UpdateMemberGladCardThread( file.gladCard, file.selectedClubMember )
...
void function UpdateMemberGladCardThread( var gladCard, ClubMember member )
{
	Signal( uiGlobal.signalDummy, "HaltPreviewClubMemberCosmetics" )
	EndSignal( uiGlobal.signalDummy, "HaltPreviewClubMemberCosmetics" )

	string memberHardware = GetNameFromeHardware( member.memberHardware )
	string memberUid = member.memberID
...
void function InspectProfileButton_OnActivate( var button )
{
	...
	friendData.hardware = GetNameFromeHardware( file.selectedClubMember.memberHardware )
