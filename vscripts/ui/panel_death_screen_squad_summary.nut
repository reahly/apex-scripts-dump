...
void function SquadSummaryOnOpenPanel( var panel )
{
	...
	foreach ( cardElem in file.panelData[ panel ].gCards )
	{
		...
		RunClientScript( "UICallback_PopulateClientGladCard", panel, cardElem, muteButton, mutePingButton, muteChatButton, reportButton, blockButton, null, overlayButton, disconnectedElem, i, Time(), presentation )
