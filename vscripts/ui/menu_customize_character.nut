...
void function RegisterNewnessCallbacks( ItemFlavor character )
{
	...
	Newness_AddCallbackAndCallNow_OnRerverseQueryUpdated( NEWNESS_QUERIES.CharacterQuipsTab[character], OnNewnessQueryChangedUpdatePanelTab, GetPanel( "CharacterEmotesPanelV2" ) )
...
void function DeregisterNewnessCallbacks( ItemFlavor character )
{
	...
	Newness_RemoveCallback_OnRerverseQueryUpdated( NEWNESS_QUERIES.CharacterQuipsTab[character], OnNewnessQueryChangedUpdatePanelTab, GetPanel( "CharacterEmotesPanelV2" ) )
