...
global function ServerCallback_PlayAmpedShieldBreakFX
#endif
...
//
const string AMPED_WALL_SCRIPT_NAME = "amped_wall"
...
string function CoverWall_UseTextOverride( entity ent )
{
	...
	if ( player.IsTitan() || !CoverWall_CanUse( player, ent ) )
	{
...
void function ServerCallback_PlayAmpedShieldBreakFX( vector origin, vector angles )
{
	int fxID = GetParticleSystemIndex( AMPED_WALL_DESTROYED_FX )
