...
global function OnWeaponAttemptOffhandSwitch_weapon_black_hole
...
const BLACKHOLE_PLAYER_3P_FX = $"P_anti_grav_3P"
...
const float BLACKHOLE_TUNING_CODE_MOVE_OUTER_SPEED = 70
const float BLACKHOLE_TUNING_CODE_MOVE_INNER_SPEED = 120
...
void function MpWeaponBlackHole_Init()
{
	...
	PrecacheParticleSystem( BLACKHOLE_PLAYER_3P_FX )
	//
	...
	PrecacheParticleSystem( BLACKHOLE_ATOM_ONPLAYER_FX )
	//
	//
...
bool function OnWeaponAttemptOffhandSwitch_weapon_black_hole( entity weapon )
{
