...
bool function PlantStickyEntityOnWorldThatBouncesOffWalls( entity ent, DeployableCollisionParams collisionParams, float bounceDot, vector angleOffset = <0, 0, 0> )
{
...
bool function EntityCanHaveStickyEnts( entity stickyEnt, entity ent )
{
	...
	//
	if ( entClassname == "prop_death_box" && stickyEntWeaponClassName == "mp_ability_translocation" )
		return true
	//
