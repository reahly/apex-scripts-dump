...
Scheme
{
	...
	BaseSettings
	{
		...
		RichText.InsetX						20
		RichText.InsetY						0		[!$NX]
		RichText.InsetY						15		[$NX]
		...
		SliderButton.CursorHeight			    	60		[!$NX]
		SliderButton.CursorHeight			    	80 		[$NX]
...
//			childGroupLocked		GridButtonLockedGroup
		...
		DetailsBoxItemButton
		{
			style					RuiButton
            rui                     "ui/loot_ceremony_details_box_item_button.rpak"
			xpos					0
			ypos					0
			zpos					2
            wide					600
		...
		MatchCharacterButton
		{
            zpos					10
			wide					194
			wide_nx_handheld		262 		[$NX]
			tall					126
			tall_nx_handheld		170 		[$NX]
			visible					0
			enabled					1
		...
		StoreCharacterButton
		{
			classname               CharacterButtonClass
			wide					194
			wide_nx_handheld		319 		[$NX]
			tall					126
			tall_nx_handheld		211 		[$NX]
			visible					0
			enabled					1
...
//            rui						"ui/lobby_character_button.rpak"
		...
		{
            wide					572
            wide_nx_handheld		650 		[$NX]
            tall					275
            tall_nx_handheld		315	 		[$NX]
			visible					1
			enabled					1
        ...
        MatchmakingStatus
        {
            ...
            wide                    560
            wide_nx_handheld        644		[$NX]
            tall                    82
            tall_nx_handheld        94		[$NX]
            visible			        1
